define(function(require, exports, module) {
	...
	Get(source) {
		...
		// this が marked になってしまう！
		//lang_name = this._Split(lang);
		//let lang_name = CodeLanguage._Split(lang);
		//this.languages.add(lang_name[0]);
		//CodeLanguage._Add(lang_name[0]);
		//CodeLanguage.Languages.add(lang_name[0]);
		//return '';
		//return renderer.protocol.code(code, lang_name[0], escaped);
	    }
	    marked.setOptions({
		renderer: renderer,
	    });
	...
	_Load() {
	    console.log('Load start.', this.languages);
